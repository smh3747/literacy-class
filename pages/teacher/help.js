  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        { q: '학생이 여러 주제 중 골라 쓰게 하려면', a: '같은 날짜로 주제를 2~3개 등록하면 학생 화면에 "오늘 주제가 N개 있어요"가 뜨고 골라서 씁니다. AI 추천 ▼ 옵션의 카테고리는 일상·관계·상상·사회 묶음으로 나뉘어 있어 방향을 잡기 쉬워요.' },   // step589
    ...
    },
    {
      ...
      content: [
        ...
        { q: '점수가 학년 수준에 비해 낮게/높게 나오는 것 같아요', a: '점수는 전 학년 같은 기준으로 채점돼요. 학년마다 평균이 달라요(고학년일수록 높은 편). 성장 그래프의 학년 평균 비교와 함께 보시면 우리 반 위치를 정확히 알 수 있어요.' }
      ]
    },
    {
      title: '🔐 보안 / 개인정보',
