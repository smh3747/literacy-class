  ...
  const sections = [
    {
      ...
      content: [
        ...
        { q: '3. API 키 발급 + 등록', a: '"🔑 Gemini API 키" 카드 → "발급 방법" 클릭 → 안내대로. 반드시 개인 @gmail.com 계정으로! 받은 키(AIza...)를 학급 API 키 칸에 붙여넣고 저장.' },
    ...
    },
    {
      ...
      content: [
        ...
        { q: '한도 초과(429) 오류가 나요', a: '학급 25명이 동시에 쓰면 분당 30회 한도를 넘을 수 있어요. 시간 분산 사용 권장.' },
    ...
    },
    {
      ...
      content: [
        ...
        { q: '"429 Too Many Requests" 오류', a: '한도 초과. 1분 후 재시도. 계속 발생하면 학급에서 시간 분산.' },
