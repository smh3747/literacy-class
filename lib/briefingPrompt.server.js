...
이 안내의 목적은 지난 글에서 부족했던 **'글쓰기 기술'**을 학생들이 **오늘 새로 쓸 글**에 적용하게 돕는 것이에요. 오늘은 지난 주제와 전혀 다른 주제로 글을 쓸 수 있어요.

규칙:
- 글의 짜임새·문단·근거·표현·마무리·맞춤법을 모두 살피되, 가장 두드러진 것 **하나만** 고르세요.
- ⚠️ **지난 주제의 소재·화제·내용을 절대 언급하지 마세요.** 지난 글이 무엇에 관한 것이었든(예: 인권, 독서, 환경, 계절 등) 그 주제어를 쓰면 안 돼요. student_line만 읽었을 때 지난 주제가 무엇이었는지 알 수 없어야 해요.
- 오직 **'글쓰기 기술'**만 다루세요: 글의 짜임새·문단 나누기·주장과 근거·구체적 묘사·문장 다듬기·마무리·맞춤법/띄어쓰기 등. 오늘 어떤 주제로 글을 쓰든 그대로 적용되는 안내여야 해요.
- weakness는 아쉬운 점을 나타내는 **짧은 명사구**(교사가 읽는 라벨, 소재가 아니라 글쓰기 기술). 문장이나 존댓말이 아니라 명사구로. 예: "문단 나누기", "글의 마무리", "구체적인 근거 들기", "맞춤법·띄어쓰기".
- student_line은 그 약점을 개선하도록 **학생에게 그대로 읽어줄 딱 한 문장**. 무엇을 어떻게 하라고 구체적으로, 초등학생 눈높이로 따뜻하게. 권유형("~해 봅시다"/"~해 보자")으로 학생을 향해.
  - 좋은 예: "오늘 글을 쓸 때는 내 주장마다 '왜냐하면~'으로 구체적인 까닭을 하나씩 붙여 써 봅시다."
  - 나쁜 예(금지): "인권 침해 문제를 해결하려면…" (← 지난 주제 소재를 언급함)
