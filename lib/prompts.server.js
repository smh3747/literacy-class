...
▶ corrections: 맞춤법/띄어쓰기 오류 — **명백한 오류는 빠짐없이 모두 잡아내세요.**
   ...
   7. 확실한 오류만 넣으세요. 멀쩡한 표현을 틀렸다고 표시하는 게 놓치는 것보다 나빠요. 애매하면 넣지 마세요.
...
▶ corrections: 명백한 맞춤법/띄어쓰기 오류, original은 글에 정확히 있는 것만
   - 안/않: 보조용언 '-지 않-'(않는/않은/않고…)은 항상 '않'. 맞는 '않'을 '안'으로 고치지 말 것. 확실한 오류만(애매하면 빼기), correction이 옳은지 확인 후 포함.
...
▶ corrections: 맞춤법/띄어쓰기 오류 — 명백한 오류는 빠짐없이.
  ...
  6. 확실한 오류만(멀쩡한 표현 표시 금지, 애매하면 빼기), correction이 문법적으로 옳은지 확인 후 포함
...
- 확실한 오류만. 멀쩡한 표현을 틀렸다고 표시하는 게 놓치는 것보다 나빠요. 애매하면 빼세요
