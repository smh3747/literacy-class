...
▶ rubric_reasons: 각 평가기준에 대한 점수 근거 (배열, scores와 길이 같음)
   ...
   - 학생 글의 구체 부분을 직접 인용해서 어디가 좋았는지 먼저 짚기
   - ⚠️ "(+15점)", "(-5점)"처럼 점수를 더하고 뺀 표기는 절대 쓰지 마세요. 점수는 scores에만 담고, 이유는 말로만 설명하세요.
   - 만점이 아니면 "~이 없어요", "~이 부족해요" 같은 진단으로 끝내지 말고, "다음엔 ~해보세요. 그러면 ~해져요"처럼 학생이 해볼 행동을 제안하는 문장으로 마무리하세요.
   예시: "'할머니 손이 거칠지만 따뜻했다'에서 감각적 표현이 살아있어요. 다음엔 거친 손을 만졌을 때의 느낌을 한두 문장 더 풀어 써보세요. 그러면 장면이 더 생생해져요."
...
▶ improve: 발전시킬 점 2가지. 형식 엄수:
   ...
   - "~이 없어요", "~이 부족해요" 같은 진단으로 끝내지 말고, "다음엔 ~해보세요. 그러면 ~해져요"처럼 행동 제안형으로 쓰세요.
...
▶ scores: 평가기준 순서대로 배열
▶ rubric_reasons (scores와 길이 같음): 각 80-150자, 학생 글을 인용한 점수 근거. "(+15점)", "(-5점)" 같은 점수 가감 표기 금지(점수는 scores에만). 아쉬운 점은 "~이 부족해요" 진단 대신 "다음엔 ~해보세요. 그러면 ~해져요" 행동 제안형으로
▶ total: 합계
...
▶ improve: 발전점 2개. 각 항목을 '- '로 시작하는 줄로 쓰고 줄바꿈으로 구분. 각 100-150자, 어디가 아쉬운지 + 어떻게 고치면 좋을지 "다음엔 ~해보세요. 그러면 ~해져요" 행동 제안형으로("~이 부족해요" 진단형 금지). ⚠️ '항목1' 같은 안내 문구를 그대로 출력하지 말 것
...
▶ rubric_reasons: 각 평가기준 점수 근거 (scores와 길이 같음)
   ...
   - 수정본의 구체적 부분을 직접 인용해서 어디가 좋았는지 먼저 짚기
   - ⚠️ "(+15점)", "(-5점)"처럼 점수를 더하고 뺀 표기는 절대 쓰지 마세요. 점수는 scores에만 담고, 이유는 말로만 설명하세요.
   - 만점이 아니면 "~이 부족해요" 같은 진단으로 끝내지 말고 "다음엔 ~해보세요. 그러면 ~해져요"처럼 행동 제안형으로 마무리하세요.
...
▶ improve: 더 발전시킬 점 2가지. 각 항목을 '- '로 시작하는 줄로 2개 쓰고 줄바꿈으로 구분.
   ...
   - "~이 없어요", "~이 부족해요" 같은 진단형 대신 "다음엔 ~해보세요. 그러면 ~해져요" 행동 제안형으로
   - 막연한 말 금지
