...
export const SCHEMAS = {
  ...
  schoolRecord: {
    ...
    properties: {
      record_long: { type: SchemaType.STRING, description: '생활기록부용 평어, 줄글, 명사형 종결, 등급어 없음, 200-300자' },
      sentences: {
        type: SchemaType.ARRAY,
        description: '독립적으로 쓸 수 있는 한 문장 평어 후보 4-5개, 각 60-80자, 구체적 근거 포함, 명사형 종결',
    ...
    required: ['record_long', 'sentences', 'strengths', 'growth']
  },
