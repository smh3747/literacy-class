...
// 📊 작업 타입별 모델 폴백 체인 (철학: 적재적소 + 일관성)
// - 'quality': 학생 글 채점/예시 - 일관성 중요 → 한도 큰 모델 우선
// - 'simple': 주제 추천/평가기준 - 단순 작업 → 한도 작은 모델로 충분
// ⚠️ Gemma 4는 한국어 응답 시 반복 루프 + 메타 텍스트 출력 문제로 제외
export const MODEL_CHAINS = {
  // 채점/예시: 25명 학생 모두 같은 모델로 일관된 평가 필요
  // → 한도 500인 3.1-flash-lite 우선 (학급 운영 충분)
  // → 한도 작은 고급 모델들은 비상시 백업
  quality: [
    'gemini-3.1-flash-lite',     // 500 RPD ⭐ (일관성 보장, 메인)
