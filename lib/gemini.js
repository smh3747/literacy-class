...
// 📊 작업 타입별 모델 폴백 체인
// - 'quality': 학생 글 채점/예시 등 품질 최우선 (Gemini Flash 우선)
// - 'simple': 주제 추천/평가기준 등 단순 생성 (Gemma 우선, Flash 보존)
// - 'default': 균형 (기존 동작)
export const MODEL_CHAINS = {
  // 채점/예시 작품: 한국어 품질 중요 → Gemini Flash 시리즈 우선
  quality: [
    'gemini-2.5-flash-lite',     // 20 RPD (가성비)
    'gemini-3.1-flash-lite',     // 500 RPD (최신, 풍부)
    'gemini-2.5-flash',          // 20 RPD (고급 보존)
    'gemini-3-flash-preview',    // 20 RPD (최신 고급)
    'gemma-4-31b-it',            // 1500 RPD (마지막 보루)
    'gemma-4-26b-a4b-it'         // 1500 RPD
  ],
  // 주제 추천/평가기준 생성: 단순 작업 → Gemma 우선 (Flash 보존)
  simple: [
    'gemma-4-26b-a4b-it',        // 1500 RPD (빠름, 가벼움)
    'gemma-4-31b-it',            // 1500 RPD (백업)
    'gemini-3.1-flash-lite',     // 500 RPD (Gemini 시작)
    'gemini-2.5-flash-lite',     // 20 RPD (가성비)
    'gemini-2.5-flash',          // 20 RPD (마지막 보루)
